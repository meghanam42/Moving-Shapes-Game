/*    Meghana Moturu mmot335 938805776: this is the animation panel
 *    ==========================================================================================
...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    protected void createNewShape(int x, int y) {
		...
		switch (currentShapeType) {
			...
			case 4:{ //create MovingPattern
				shapes.add( new MovingPattern(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor,currentFillColor, currentPathType));
				break;
			}
		}
    }
